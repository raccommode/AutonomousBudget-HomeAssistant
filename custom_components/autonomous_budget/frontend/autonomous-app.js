import "./autonomous-budget-panel.js?v=1.2.0";
import "./finance-panel.js?v=1.2.0";
import { baseCSS, esc } from "./shared.js?v=1.2.0";
import { translate } from "./i18n.js?v=1.2.0";
