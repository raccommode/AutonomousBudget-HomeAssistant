import "./autonomous-budget-panel.js?v=1.4.1";
import "./finance-panel.js?v=1.4.1";
import { baseCSS, esc, icon } from "./shared.js?v=1.4.1";
import { translate } from "./i18n.js?v=1.4.1";
