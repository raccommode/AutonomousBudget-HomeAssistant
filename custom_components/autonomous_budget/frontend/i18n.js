...
const fr = {
  ...
  "Enter balances manually in the budget currency. Available after reserves = account balance − credit owed − projected reserves. Leave account balance blank to hide this estimate.": "Saisissez les soldes manuellement dans la devise du budget. Disponible après réserves = solde du compte − crédit à rembourser − réserves prévisionnelles. Laissez le solde vide pour masquer cette estimation.",
