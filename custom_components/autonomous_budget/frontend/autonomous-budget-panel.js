import { BudgetLiveElement, baseCSS, esc, icon, labels, options } from "./shared.js?v=1.5.0";
...
class AutonomousBudgetPanel extends BudgetLiveElement {
  ...
  render() {
    ...
    view.innerHTML = `<div class="shell">
      ...
      <div class="footer row between"><span>Stored in Home Assistant</span><span>Autonomous Budget · 1.5.0</span></div>
    </div>`;
  }
