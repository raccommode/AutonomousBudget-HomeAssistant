import { BudgetLiveElement, baseCSS, esc, icon, labels, options } from "./shared.js?v=0.3.0";
...
class AutonomousBudgetPanel extends BudgetLiveElement {
  ...
  render() {
    ...
    view.innerHTML = `<div class="shell">
      ...
      <div class="footer row between"><span>Local to your home. In sync with your life.</span><span>Autonomous Budget · 0.3.0</span></div>
    </div>`;
  }
