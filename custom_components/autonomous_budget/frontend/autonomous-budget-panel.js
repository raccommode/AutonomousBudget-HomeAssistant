import { BudgetLiveElement, baseCSS, esc, icon, labels, options } from "./shared.js?v=1.0.1";
...
class AutonomousBudgetPanel extends BudgetLiveElement {
  ...
  render() {
    ...
    view.innerHTML = `<div class="shell">
      ...
      <div class="footer row between"><span>Local to your home. In sync with your life.</span><span>Autonomous Budget · 1.0.1</span></div>
    </div>`;
  }
